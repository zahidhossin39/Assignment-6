...
const ProductsCard = ({ product }) => {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-7 flex flex-col gap-0 transition-all duration-300 hover:shadow-xl hover:shadow-violet-100 hover:-translate-y-1 cursor-default">
      ...
      {/* CTA Button */}
      <button className="w-full py-3.5 bg-gradient-to-r from-violet-600 to-purple-600 text-white text-sm font-semibold rounded-xl tracking-wide cursor-pointer transition-all duration-200 hover:opacity-90 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-violet-300 active:translate-y-0 active:opacity-100">
        Buy Now
      </button>
    </div>
  );
